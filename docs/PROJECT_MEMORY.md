...
44. Tratar a proximidade da alça como limite real da personalização: manter proteção transparente de `3%` em cada lateral do gabarito, aplicar o mesmo recorte no editor e no PNG e mascarar no 3D a superfície localizada sob a alça. O preenchimento inicial pode ampliar automaticamente até `140%`, mas nunca elimina essa proteção.
