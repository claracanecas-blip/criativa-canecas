...
- Quando a Web Share API aceita arquivos, `Enviar foto e pedido pelo WhatsApp` abre o seletor nativo com o original e um resumo curto; no celular, o cliente escolhe o WhatsApp e a conversa da Criativa.
- Para evitar duas ações concorrentes, o link universal aparece somente quando o aparelho não aceita o compartilhamento do arquivo. Ele abre o WhatsApp com modelo, nome do arquivo, frase, detalhes, pedido de mockup e campo de cidade/CEP.
