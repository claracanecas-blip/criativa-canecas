...
import { Crosshair, Maximize2, Move, Scan } from '@lucide/vue'
import {
...
<template>
  <section class="photo-editor" aria-labelledby="photo-editor-title">
    ...
    >
      ...
      <span class="print-guide" aria-hidden="true"><small>Área aproximada de impressão</small></span>
    ...
    <p id="photo-editor-help" class="editor-help">No teclado, use as setas para mover, + ou − para ampliar e Home para centralizar.</p>
