...
import ProductSocialProof from '@/components/ProductSocialProof.vue'
...
const images = computed(() => product.value?.imagens?.length
  ? product.value.imagens
  : product.value?.imagem ? [product.value.imagem] : [])
...
<template>
  ...
  <article v-else-if="product" class="product-page section container">
    ...
    <div class="product-layout">
      <ProductGallery :images="images" :product-name="product.nome" />
    ...
    <ProductInformation :product-name="product.nome" />
    <ProductSocialProof />
