...
<template>
  <section class="admin-shell container">
    <header class="admin-heading">
      ...
      <div class="admin-actions"><RouterLink class="secondary-button" to="/admin/informacoes">Informações e FAQ</RouterLink><RouterLink class="secondary-button" to="/admin/depoimentos">Depoimentos</RouterLink><button class="secondary-button" type="button" @click="logout"><LogOut :size="17" /> Sair</button></div>
    </header>
...
@media(max-width:700px){.admin-heading{align-items:flex-start;flex-direction:column;gap:12px}.admin-actions{justify-content:flex-start;width:100%}.toolbar{flex-wrap:wrap}.toolbar>input{flex-basis:100%}.form-grid{grid-template-columns:1fr}.wide{grid-column:auto}.check-grid{grid-template-columns:1fr 1fr}.editor{padding:16px}.editor-actions{flex-direction:column-reverse}.editor-actions button{width:100%}}
</style>
